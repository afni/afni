...
EXAMPLES = f"""
=============================================================================
run_afni_tests.py examples -v      - usage examples for run_afni_tests.py
...
---------------------------------------------------------------------------
## Basic examples (testing on the local host):
...
## Important: It's pytest under the hood
...
## Modifying the reporting of a tests run

### Altering test reporting verbosity
...
The above command makes use of the --pdb pytest option under the hood. Additionally --trace
...
### Running current test suite in pre-existing container
