...
#
# This program is licensed to you under the terms of version 3 of the GNU Affero General
# Public License. This program is distributed WITHOUT ANY EXPRESS OR IMPLIED WARRANTY,
# INCLUDING THOSE OF NON-INFRINGEMENT, MERCHANTABILITY OR FITNESS FOR A PARTICULAR
# PURPOSE. Please refer to the AGPL (http://www.gnu.org/licenses/agpl-3.0.txt) for more
# details.
#

# LIBR_FOUND LIBR_HOME LIBR_INCLUDE_DIRS LIBR_DOC_DIR LIBR_LIBRARIES
...
if(APPLE)
  ...
  if(LIBR_LIBRARIES MATCHES ".*\\.framework")
    set(LIBR_HOME
        "${LIBR_LIBRARIES}/Resources"
        CACHE PATH "R home directory"
    )
    set(LIBR_INCLUDE_DIRS
        "${LIBR_HOME}/include"
        CACHE PATH "R include directory"
    )
    set(LIBR_DOC_DIR
        "${LIBR_HOME}/doc"
        CACHE PATH "R doc directory"
    )
    set(LIBR_EXECUTABLE
        "${LIBR_HOME}/bin/R"
        CACHE PATH "R executable"
    )
  else()
  ...
  if(UNIX)
    ...
    if(NOT LIBR_HOME)
      ...
      get_filename_component(
        LIBR_HOME "[HKEY_LOCAL_MACHINE\\SOFTWARE\\R-core\\R;InstallPath]" ABSOLUTE
        CACHE
      )
    ...
    execute_process(
      ...
      OUTPUT_VARIABLE LIBR_DLL2LIB_STDOUT
      ERROR_VARIABLE LIBR_DLL2LIB_STDERR
  ...
  find_program(LIBR_EXECUTABLE R HINTS ${LIBRARY_ARCH_HINT_PATH} ${LIBR_HOME}/bin)
  if(LIBR_EXECUTABLE-NOTFOUND)
    message(STATUS "Unable to locate R executable")
  endif()
  ...
  if(LIBR_LIBRARIES)
    set(LIBR_LIBRARIES
        ${LIBR_LIBRARIES}
        CACHE PATH "R runtime libraries"
    )
  endif()
...
mark_as_advanced(LIBR_CORE_LIBRARY LIBR_LAPACK_LIBRARY LIBR_BLAS_LIBRARY)
