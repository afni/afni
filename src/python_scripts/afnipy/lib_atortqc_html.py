...
ver = '1.00' ; date = 'Nov 3, 2022'
# [PT] start for ATORTQC, heavily modeling on APQC functionality
#
#########################################################################
...
qc_title["Top"]    = [ "Top of page for:&#10  ${subj}", 
                       "TORTOISE single subject report" ]
...
atortqc_help = [ 
['HELP FILE FOR ATORTQC', 
 '''      *** TORTOISE's single subject QC report form ***
