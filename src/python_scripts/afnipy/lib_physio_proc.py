...
# Local libraries
import lib_physio_peaks as lpf
import lib_physio_plot as lrp
import lib_physio_graph as lrg
...
def getRespiratoryPeaks(test_retro_obj):
   ...
   ARGUMENTS
       test_retro_obj:   object which includes the following fields.
            ...
            resp_data: (dType = <class 'lib_physio_reading.phys_ts_obj'>) Object
               containing the following fields.
...
def getPhysiologicalNoiseComponents(test_retro_obj):
    ...
    TYPE
        test_retro_obj: (dtype = <class 'lib_physio_reading.retro_obj'>)
    ...
    ARGUMENTS
        test_retro_obj:   Object with the following fields.
            ...
            card_data:   (dtype = <class 'lib_physio_reading.phys_ts_obj'>)
            ...
            resp_data:     (dtype = <class 'lib_physio_reading.phys_ts_obj'>)
                         Object containing the following fields.
