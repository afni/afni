...
# import OptionList, read_options
...
#    assert o.is_strict JL's default
    return o
...
class ShellComFuture(ab.shell_com):
    ...
    def __init__(
        self, com, eo="", capture=1, default_text="Text from future"
    ):
        ...
        super().__init__(
            com, eo=eo, capture=capture, save_hist=0
        )
...
class PipelineConfig:
    ...
    def init_opts(self):
        self.valid_opts = ol.OptionList("init_opts")
