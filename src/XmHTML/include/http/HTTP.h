...
* <space>
* <extra fields, for development software, a point of contact is recommended
* \r\n terminator
* 
...
/* type of cookie file 
 *   For safety I am only going to support the writing of CookieJar files
 ...
 *     loadHTTPUrl() since it gives tha application chnace to receive any new 
 *     cookies.
 ...
 *  5) for permanent saving of the cookies the application needs to call    
 *     writeCookieCache();
 */
