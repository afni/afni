...
/*****
* Original GNU regex is part of another package which includes the
* configure stuff. Until we get XmHTML working properly with autoconf,
* we set some reasonable defaults instead.
*****/
#ifdef HAVE_CONFIG_H
# include "config.h"
#else
