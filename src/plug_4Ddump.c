...
static char helpstring[] =
  ...
  "The time series to be extracted are specified either by AFNI index or by XYZ corrdinates.\n\n"
  "Data field\n"
  "   Data : Select the 3D+time data set\n"
  "   Ignore : Specify the number of points to ignore\n"
  "   Dtrnd : Apply detrending to time series (y/n). \n"
  "           If the dtrnd option is off, time series do not have zero mean.\n\n"
  "Mask filed\n"
  "   Mask File : The index or XYZ coordinates are specified in an ascii file.\n"
  "               Each line in the ascii file holds the index or XYZ coordinates \n"
  "               of the voxel to be extracted. Each line of the ascii file can hold many\n"
  "               values, the user chooses which ones correspond to i or the XYZ triplet.\n"
  "               The XYZ coordinates used for masking correspond to those shown in the \n"
  "               AFNI window and NOT the graph window.\n"
  "   N Columns : Total number of values on each line in the ascii file\n\n"
  "Index Mask field\n"
  "   i col : Specify the column number where the index is stored in the mask file\n\n"
  "XYZ Mask field\n"
  "   x col., y col., z col. : Specify the column numbers where X Y Z triplets are stored\n\n"
  "Output field\n"
  "   Filename : Name of the ascii file wheretThe time series are written to.\n"
  "              If no output filename is specified, the ouput is Old-Prefix.4Ddump.\n"
  "   Format : ts[1] ts[2] .... -> one time series per line\n"
  "            i x y z ts[1] ts[2] .... -> index, XYZ coordinates and time series per line .\n"
