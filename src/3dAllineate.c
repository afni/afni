...
"               lets you see what voxels were important in the algorithm.\n"
     ...
     if( argc > 1 &&
       ...
       printf(
        ...
        "       0.4243801+0.4973406*cos(PI*x)+0.0782793f*cos(2*PI*x)\n"
        ...
        "     is 0.  A larger value means that fewer points are tapered inside\n"
        ...
        "     good and articulable reason!  (Or if you like to screw around.)\n"
       ) ;
