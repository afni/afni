...
"                        the registration itself -- 515 points (those\n"
"                        within a radius of 5 grid points in 3 dimensions)\n"
"                        are used to interpolate each output value.\n"
...
"                   ++ On my Intel-based Mac, it takes about 16 s to do\n"
"                        wsinc5 interpolation, per 1 million voxels output.\n"
"                        For comparison, quintic interpolation takes about\n"
"                        0.3 s per 1 million voxels: 50 times faster.\n"
"                        Perhaps I should do something about this, someday.\n"
"\n"
