...
"               lets you see what voxels were important in the algorithm.\n"
     ...
     if( argc > 1 &&
       ...
       printf(
        ...
        "-------------------------\n"
        " ** If you set environment variable AFNI_WSINC5_SPHERICAL\n"
        "      to the value 'YES' (e.g., use the command line option\n"
        "      -DAFNI_WSINC5_SPHERICAL=YES), then a spherical masked\n"
        "      interpolation will be used, rather than a cubical mask.\n"
        "      This method is MUCH slower, and I'm not sure it has any\n"
        "      value, but it's there if you have nothing better to do.\n"
        " ** If you set environment variable AFNI_WSINC5_RADIUS to the\n"
        "      value '7' (e.g., -DAFNI_WSINC5_RADIUS=7), then the radius\n"
        "      of the interpolation mask will be 7 voxels rather than 5\n"
        "      (for either the cubical or spherical mask).  Again, this\n"
        "      option is just for fooling around, and of course it will\n"
        "      slow the program down even more.  NOTE: only the value '7'\n"
        "      can be used here; any other value will result in the default\n"
        "      radius of 5.\n"
       ) ;
