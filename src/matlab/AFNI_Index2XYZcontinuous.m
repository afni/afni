function [err,XYZmm] = AFNI_Index2XYZcontinuous (Indx, Info, CoordCode)
%
%   [err,XYZmm] = AFNI_Index2XYZcontinuous (Indx, Info, [CoordCode])
%
%Purpose:
%   Change from voxel XYZindex to XYZ in mm
%   
%   
%Input Parameters:
...
%       The coordnate system output is always in RAI (DICOM) unless otherwise specified by CoordCode
%   
%      
%Key Terms:
%   
...
%
%     Author : Ziad Saad
%     Date : Tue Sep 5 21:48:06 PDT 2000
...
if (ChangeCoord),
	[err, maplocation, mapsign, XYZmm] = AFNI_CoordChange ('RAI', CoordCode, XYZmm);
end
