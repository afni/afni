...
# and using merely affine alignment to a template.
...
Overview:
   ...
   1. This program places output in the current directory, so it should be
      run from a "clean" location, generally away from the raw inputs.
