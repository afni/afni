...
static void fft_shift2( int n, int nup, float af, float * f, float ag, float * g )
{
   static int nupold=0 , nuptop=0 , ntaper=0 , ntbase=0 ;
   static complex * row=NULL , * cf=NULL , * cg=NULL ;
   static float   * taper=NULL ;
   ...
   if( nup != nupold ){
      ...
      if( nup > nupold ){
         ...
         taper = (float *) malloc( sizeof(float) * ntaper ) ;
      }
      sf = PI / (ntaper+1) ;
      for( ii=0 ; ii < ntaper ; ii++ )              /* our friend the */
   ...
   for( ii=ntbase ; ii < nby2 ; ii++ ){     /* ntaper + ntbase = nby2+1 */
      ...
      row[nup-ii].r *= taper[ii-ntbase] ;
      row[nup-ii].i *= taper[ii-ntbase] ;
   }
...
static void hept_shift( int n , float af , float * f )
{
   int   ii , ia , ix ;
...
static void hept_shift2( int n, int nup, float af, float * f, float ag, float * g )
{
                   hept_shift( n , af , f ) ;
...
static void quint_shift( int n , float af , float * f )
{
   int   ii , ia , ix ;
...
static void quint_shift2( int n, int nup, float af, float * f, float ag, float * g )
{
                   quint_shift( n , af , f ) ;
...
static void cub_shift( int n , float af , float * f )
{
   int   ii , ia , ix ;
...
static void cub_shift2( int n, int nup, float af, float * f, float ag, float * g )
{
                   cub_shift( n , af , f ) ;
...
static void lin_shift( int n , float af , float * f )
{
   int   ii , ia , ix ;
...
static void lin_shift2( int n, int nup, float af, float * f, float ag, float * g )
{
                   lin_shift( n , af , f ) ;
...
static void nn_shift( int n , float af , float * f )
{
   int   ii , ia , ix ;
...
static void nn_shift2( int n, int nup, float af, float * f, float ag, float * g )
{
                   nn_shift( n , af , f ) ;
