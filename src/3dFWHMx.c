...
int main( int argc , char *argv[] )
{
   ...
   if( argc < 2 || strcmp(argv[1],"-help") == 0 ){
     printf(
      ...
      "        ******* If you don't use '-detrend', the program now checks\n"
      "                if a large number of voxels are have significant\n"
      "                nonzero means. If so, the program will print a\n"
      "                warning message suggesting the use of '-detrend',\n"
      "                since inherent spatial structure in the image will\n"
      "                bias the estimation of the FWHM of the image time\n"
      "                series NOISE (which is usually the point of 3dFWHMx).\n"
