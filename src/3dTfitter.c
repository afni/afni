...
int main( int argc , char *argv[] )
{
   ...
   if( argc < 2 || strcmp(argv[1],"-help") == 0 ){
     printf(
      ...
      "  with the kernel function, fits the data.\n"
      "\n"
      ...
      "                     j                     i\n"
      "\n"
      "  where K() is the user-supplied kernel function, and S() is the\n"
      "  source function to be estimated.\n"
      "\n"
      ...
      "  or L1 (least sum of absolute errors) senses.\n"
      "\n"
      "-------------------------------------\n"
