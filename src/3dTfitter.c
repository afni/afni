...
int main( int argc , char *argv[] )
{
   ...
   if( argc < 2 || strcmp(argv[1],"-help") == 0 ){
     printf(
      ...
      "             * More than one 'lab' can follow the '-label' option, but each\n"
      "               label must NOT start with the '-' character!\n"
      ...
      "             * L1 fitting is slower than L2 fitting.\n"
      "\n"
      ...
      "             * Parameter counting starts with 1 for this option.\n"
      "             * Constraints are not available with '-lsqfit',\n"
      "               only with '-l1fit'; if you use '-consign' with '-lsqfit',\n"
      "               the program will print a warning and ignore constraints.\n"
      "\n"
