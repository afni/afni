...
void XCAT_Syntax(void)
{
   printf(
    ...
    "* Catenates datasets spatially (for time, see 3dTcat).\n"
    "* The input datasets must match, in the sense that the pieces\n"
    "  fit together properly.\n"
    "* A generalization of 3dZcat, for my own demented purposes (RWC).\n"
    "\n"
    "Options:\n"
