...
"   before processing.\n"
" * As of June 2018, the FFT length used is NOT rounded up to a\n"
"   convenient FFT radix; instead, the FFT size is actual value supplied\n"
"   in option '-nfft' or the number of time point (if '-nfft' isn't used).\n"
" * However, if the FFT length has large prime factors (say > 29), the\n"
