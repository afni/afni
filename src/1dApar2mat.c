...
int main( int argc , char *argv[] )
{
   ...
   if( argc < 2 || strncasecmp(argv[1],"-h",2) == 0 ){
     printf("\n"
            ...
            "    used the '-EPI' option, then the order of parameters for\n"
            "    3dAllineate will no longer be the same as the use inside\n"
            "    1dApar2mat. In such a situation, the matrix output by\n"
