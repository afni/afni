...
void TS_syntax(char * str)
{
   ...
   printf("Usage: 3dTshift [options] dataset\n"
          ...
          "data, but it can be convenient.  Please recall the phenomenon of\n"
          "'aliasing': frequencies above 1/(2*TR) cannot be properly interpolated.\n"
          "For most 3D FMRI data, this means that cardiac and respiratory effects\n"
          "will not be treated properly by this program.\n"
          "\n"
          "Options:\n"
