...
# 02/26/2023: funtion used to compare smoothing fitting between two groups (binary coding with -1/1 or 0/1)
...
if(!is.null(lop$sdiff)) brickNames <- c(brickNames, sdiffLabel, paste0(sdiffLabel, '.se'))
