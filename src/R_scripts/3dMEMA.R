...
##  May encounter memory with many subjects because of lamda & Z-score for residuals of each subject
##  version for b, t, tau^2, lamda, residual Z-score, but no covariates, no outlier modeling, June 10, 2009
#########
