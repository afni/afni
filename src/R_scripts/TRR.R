...
------ 
 ...
 effect (e.g., one condition or average across conditions). 
...
=============================== 
 ...
 3) If there are more than 4 CPUs available, one could take advantage of within
    ...
    \'cmdstanir\', execute the following command in R:
    install.packages(\'cmdstanr\', repos = c(\'https://mc-stan.org/r-packages/\', getOption(\'repos\')))
    Follow the instruction here for the installation of \'cmdstan\' (and put it
    under your home directory ~/cmdstan): 
...
Example 2 --- TRR estimation for a contrast between two conditions. Input
   ...
   TRR -prefix myTRR -chains 4 -iterations 1000 -Y RT -subject Subj \\
      -repetition sess -condition cond -WCP 6 -dataTable myData.tbl   \\
