...
void Syntax(void)
{
   printf(
    ...
    "      'master' dataset to start with.  If you want to make further\n"
    "      specify the voxel sizes (in mm), you can use 3drefit to alter\n"
    "      such parameters after the initial act of creation ab nihilo.\n"
    "\n"
