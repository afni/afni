...
#endif
   memset(&bb,0,sizeof(THD_mat33)); memset(&aa,0,sizeof(THD_mat33));
   /* rotation */
...
"\n"
"* Here, the spatial transformation is defined by a matrix; thus,\n"
...
"\n"
"Note other more modern+specific programs for alignment to consider:\n"
"\n"
"* For nonlinear spatial warping, see program 3dQwarp, as well as its\n"
"  useful wrappers, such as sswarper2, @animal_warper, etc.\n"
"\n"
"* For a more general affine alignment procedure, consider 3dAllineate;\n"
"  that program does not require the two datasets be on the same grid.\n"
"\n"
"* For affine EPI-anatomical alignment (and other affine alignments),\n"
"  consider align_epi_anat.py (which is a wrapper for 3dAllineate), which\n"
"  does not require the two datasets be defined on the same 3D grid.\n"
"\n"
"-------------------------------------------------------------------------\n"
"Transform-Defining Options ~1~\n"
"\n"
...
"\n"
"NB: At this time, the image intensity is NOT adjusted for the\n"
"    Jacobian of the transformation.\n"
"\n"
"NB: -bilinear_general is not yet implemented. AND WILL NEVER BE.\n"
"\n"
"-------------------------------------------------------------------------\n"
"Other Options ~1~\n"
"\n"
...
"                      NB: This matrix is the coordinate transformation\n"
"                      from base to input DICOM coordinates.  To get the\n"
"                      inverse matrix (input-to-base), use the cat_matvec\n"
"                      program, as in: cat_matvec fred.aff12.1D -I\n"
"\n"
"-------------------------------------------------------------------------\n"
