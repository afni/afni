# Quick build setup script 3/3.  Should match with 'steps_linux_ubuntu24.rst'
# From bash shell:
#   tcsh OS_notes.linux_ubuntu_24_64_c_nice.tcsh 2>&1 | tee o.ubu_24_c.txt
# From tcsh shell:
#   tcsh OS_notes.linux_ubuntu_24_64_c_nice.tcsh |& tee o.ubu_24_c.txt
