...
void Qhelp(void)
{
  ...
  printf(
    ...
    "\n"
    "* 3dQwarp is where nonlinear warps come from (in AFNI).\n"
    ...
    "Formulae for these 3 polynomials can be found in function HQwarp_eval_basis()\n"
    "in AFNI file mri_nwarp.c. For each Qi, Qi(+/-1)=Qi'(+/-1)=Qi''(+/-1) = 0;\n"
