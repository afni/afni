...
"                     command line.\n" 
" -linkrbrain: get report from " LINKRBRAIN_SITE " from list of coordinates\n"
...
/*         print_atlas_list(get_G_atlas_list());*/
   ...
   if (linkrbrain_output){
     ...
     if(make_linkrbrain_xml(coord_list, nxyz, srcspace, "MNI", linkrbrain_xml,
        ...
        if( lll != 0 ){
           fprintf(stderr,"** Error: could not link to" LINKRBRAIN_SITE
        ...
        /* parse the output here. For now just say it's there */
           printf(
        "Query of coordinates to " LINKRBRAIN_SITE " correlations\n\n");
