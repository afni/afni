   ...
   ENTRY("whereami_usage");
      ...
      do { 
       ...
       printf( "--------------------------------------\n\n" 
               ...
               "The 3 spaces are Talairach (TLRC), MNI, MNI Anatomical (MNIa). All three\n"
               ...
               "The MNIa coordinates are a shifted version of the MNI coordinates (see Eickhoff et al. 05).\n"
               " However since the MNI coordinates reported here are derived from TLRC by an approximate \n"
               " function it is best to derive the MNIa coordinates in a different manner.\n"
               " This is possible because the MNIa coordinates are defined relative to the single-subject N27 \n"
               " dataset. MNIa coordinates are thus derived via the 12 piece-wise linear transformations \n"
