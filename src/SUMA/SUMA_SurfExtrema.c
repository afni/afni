...
SUMA_GENERIC_PROG_OPTIONS_STRUCT *SUMA_SurfExtrema_ParseInput(char *argv[], int argc, SUMA_GENERIC_ARGV_PARSE *ps)
{
...
{/* Main */    
   ...
   if (!(dout = SUMA_DsetAvgGradient(SO, NULL, din, Opt->nmask, 0)))  {
