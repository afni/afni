...
"\n"
 ...
 "    byr64, ROI_i128, ROI_i256, ROI_i64, Viridis,.... \n"
 "    (see suma's cmaps for updated list)\n"
 ...
 "   The header line must be included EXACTLY as above (#integer label ...)\n"  
 "\n"
 ...
 "   pass with:\n"
 "       MakeColorMap -usercolutfile colut.txt -suma_cmap toylut \\\n"
 "                    -sdset you_look_marvelous.niml.dset\n"
 "\n"
