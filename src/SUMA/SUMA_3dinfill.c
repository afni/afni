...
"end. Here, a zero voxel is considered a hole if it cardinal ray emanating \n"
"from it encounter non-zero voxels on either end in at least two of the \n"
"cardinal directions (minhits = 2). \n"
"Removal of dangling chunks: After no holes remain, the volume is\n"
"edited so that no zero voxels bound in ONLY one (3-minhits) direction\n"
"remain.\n"
"        3dinfill -blend SOLID_CLEAN -prefix filledmask \\\n"
