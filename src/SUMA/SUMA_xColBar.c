                           ...
                           SUMA_Boolean NewMap)
{
   ...
   switch (ado->do_type) {
      ...
      case GDSET_type:
         ...
         SUMA_RETURNe;
      case CDSET_type:
         SUMA_S_Err("Figure me out please");
         SUMA_RETURNe;
      case GRAPH_LINK_type:
...
void SUMA_CreateXhairWidgets(Widget parent, SUMA_ALL_DO *ado)
{
   ...
   switch (ado->do_type) {
      ...
      case GDSET_type:
         ...
         SUMA_RETURNe;
      case CDSET_type:
         SUMA_S_Err("Write function for me love");
         SUMA_RETURNe;
         break;
      case GRAPH_LINK_type:
...
SUMA_Boolean SUMA_UpdateNodeField(SUMA_ALL_DO *ado)
{
   ...
   switch (ado->do_type) {
      ...
      case GDSET_type: {
         ...
         break; }
      case CDSET_type: {
         SUMA_S_Err("Need some sould searching here");
         SUMA_RETURN(NOPE);
         break; }
      case VO_type:
      case TRACT_type:
...
SUMA_Boolean SUMA_UpdatePointField(SUMA_ALL_DO*ado)
{
   ...
   switch (ado->do_type) {
      ...
      case GDSET_type: {
         ...
         break; }
      case CDSET_type: {
         SUMA_S_Err("Figure out the answers to life's persistent questions");
         SUMA_RETURN(NOPE);
         break; }
      case GRAPH_LINK_type:
         {
...
SUMA_Boolean SUMA_UpdateNodeLblField_ADO(SUMA_ALL_DO *ado)
{
   ...
   switch(ado->do_type) {
      case CDSET_type:
         SUMA_S_Err("And how will you be remembered?");
         SUMA_RETURN(NOPE);
         break;
      case VO_type:
      case GRAPH_LINK_type:
   ...
   switch (ado->do_type) {
      ...
      case VO_type: {
         ...
         *over = NULL;
         ...
         break; }
      case CDSET_type: {
         SUMA_S_Err("Tell me how this will end");
         SUMA_RETURN(NOPE);
         break; }
      case GDSET_type: {
         SUMA_DSET *dset=(SUMA_DSET *)ado;
...
SUMA_OVERLAYS **  SUMA_ADO_Overlays(SUMA_ALL_DO *ado, int *N_over)
{
   ...
   switch(ado->do_type) {
      case SO_type: {
         ...
         break; }
      case CDSET_type: {
         SUMA_S_Err("Not implemented ahora");
         return(NULL);
         break; }
      case GDSET_type: {
         SUMA_DSET *dset=(SUMA_DSET *)ado;
...
int SUMA_ADO_N_Overlays(SUMA_ALL_DO *ado)
{
   ...
   switch(ado->do_type) {
      case SO_type: {
         ...
         break; }
      case CDSET_type: {
         SUMA_S_Err("Not living up to the hype are you?");
         return(-1);
         break; }
      case GDSET_type: {
         SUMA_DSET *dset=(SUMA_DSET *)ado;
...
int SUMA_ADO_SelectedDatum(SUMA_ALL_DO *ado, void *extra, void *extra2)
{
   ...
   switch(ado->do_type) {
      case SO_type: {
         ...
         break; }
      case CDSET_type: {
         SUMA_S_Err("Still far from Jerusalem");
         return(-1);
         break; }   
      case GDSET_type: {
         SUMA_DSET *dset=(SUMA_DSET *)ado;
...
int SUMA_ADO_SelectedSecondary(SUMA_ALL_DO *ado)
{
   ...
   switch(ado->do_type) {
      case SO_type: {
         ...
         break; }
      case CDSET_type: {
         SUMA_S_Err("Running out of stupid messages fast!");
         return(-1);
         break; }
      case GDSET_type: {
         SUMA_DSET *dset=(SUMA_DSET *)ado;
...
float *SUMA_ADO_DatumXYZ(SUMA_ALL_DO *ado, int isel, char *variant) 
{
   ...
   switch (ado->do_type) {
      case SO_type: {
         ...
         break; }
      case CDSET_type: {
         SUMA_S_Err("Baisers et cocquillages");
         return(NULL);
         break;
         }
      case GDSET_type: {
...
void *SUMA_ADO_Saux(SUMA_ALL_DO *ado) 
{
   ...
   switch (ado->do_type) {
      case SO_type: 
         ...
         break;
      case CDSET_type:
         return((void *)SDSET_CSAUX((SUMA_DSET *)ado));
         break;
      case GDSET_type:
