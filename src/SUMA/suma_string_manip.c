...
/*
   A function to explain clipping plane behaviour.
*/
void SUMA_Clipping_Planes_Help(FILE *fout, int forweb)
{
   ...
   char *s0=NULL;
   char intro[]={
"Clipping planes are used to select only the volume of the active \n"
"surface objects that one is interested in.  Several surface objects\n"
"may be included in this volume but parts of the objects, outside the\n"
"volume are invisible so as not to obscure the parts of interest\n"
"\n"
};
   char s[] = {
"Enter clipping plane mode with Shift-Ctrl-C.  There can be up to \n"
"6 clipping planes numbered [1-6].  Each has a separate color \n"
"being in order R G B C M Y.  So plane 1 can be viewed in\n"
"Red, plane 4 in Cyan, etc.  The clipping planes may be viewed, \n"
"as squares, with shift-C which toggles the squares on and off.\n\n"
"Below, \"a number\" can be in range [1-6].  \"active\" means\n"
"a clipping plane is clipping, not just visible.  The \"selected\" \n"
"plane is controlled with the action keys.\n\n"
"Clipping planes can be scrolled along their normals and/or \n"
"rotated around their tangent or cotangent axis. Currently, the \n"
"increment of  one is also the increment of the others.  The \n"
"default increment is 1.0  where the tilt increment is in degrees. \n"
"The minus (-) key halves the  increment from its current value. \n"
"The + key doubles the increment from  its current \n"
...
"Key+mouse behavior\n"
"------------------\n\n"
"\ta: Toggle Cartesian axes on/off.\n\n"
...
"\tw: Write clipping planes, and their environment \n"
"\t\tvariables, to file.\n\n"
"\t[a number]: Toggle the clipping behavior of numbered plane on/off\n\n"
"\talt/cmd/opt-[a number]: Select the numbered clipping plane (so\n"
...
"\t0: Reset all clipping planes.\n\n"
"\t7: Toggle all active clipping planes on or off.\n\n"
"\tAlt/Cmd/Opt+[scroll-wheel]: Translate a clipping plane in space.\n\n"
