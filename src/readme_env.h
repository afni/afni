...
static char *readme_env[] = {
   ...
   "it to be longer, increase this value. Music can only be played if\n" ,
   "a sound player program is installed on your computer, as described\n" ,
   "under AFNI_SOUND_PLAYER above.\n" ,
   "\n" ,
   "-----------------------------\n" ,
