...
static char *readme_env[] = {
   ...
   "from SUMA to AFNI. This applies to surface number 'xxx', for xxx=001, 002,\n" ,
   "etc. If this is set to \"none\", then these boxes (at each node near a slice)\n" ,
   "won't be plotted.\n" ,
   ...
   "from SUMA to AFNI. This applies to surface number 'xxx', for xxx=001, 002,\n" ,
   " etc. If this is set to \"none\", then these lines (intersections of surfaces\n" ,
   "with slices) won't be plotted.\n" ,
   "For the special case of xxx=DEF, then the specified color becomes the default\n" ,
   "across all surface numbers (though you can still adjust individual colors\n" ,
   "for xxx=001, etc.\n" ,
   "\n" ,
   "---------------------------------------\n" ,
   "Variable: AFNI_SUMA_LINECOLOR_FORCE_xxx\n" ,
   "---------------------------------------\n" ,
   "This variable is similar to AFNI_SUMA_LINECOLOR_xxx (again, for xxx=001,\n" ,
   "etc.), except for one detail. When SUMA sends a surface to AFNI for display,\n" ,
   "it can also send a color. If that happens, then AFNI_SUMA_LINECOLOR_xxx will\n" ,
   "have no effect. But AFNI_SUMA_LINECOLOR_FORCE_xxx will over-ride the choice\n" ,
   "SUMA makes and forces the color for surface number 'xxx' to be this color.\n" ,
   "The special case usage of xxx=DEF also applies here.\n" ,
   "\n" ,
   "---------------------------\n" ,
   ...
   "Maybe this has to do with DARTEL output.\n" ,
   "\n" ,
   "--------------------------------\n" ,
