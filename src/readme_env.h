static char * readme_env[] = {
   ...
   "order (x,y,z) coordinates will be written to the file whose name is\n" ,
   "given by the value of this variable.  As a special case, if the\n" ,
   "filename is 'stdout', then the coordinates are written to standard\n" ,
   "output.  A sample command\n" ,
   "\n" ,
   ...
   "\n" ,
   "This feature may be referred to as the Jennifer Evans special.\n" ,
   "\n" ,
   "----------------------------------------------------------------------\n" ,
