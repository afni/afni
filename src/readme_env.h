static char * readme_env[] = {
   ...
   "\n" ,
   "[Dec 2007] You can now specify the colors using the 3 special names\n" ,
   "'green', 'red', and 'blue'.  Also, by using 3 or 6 digit hexadecimal notation\n" ,
   "as in '#ff00ff' for a purplish color (6 digits) or '#fc0' for a goldish\n" ,
   "color (3 digits).  These are intended to make life a little simpler for you.\n" ,
   "\n" ,
   "--------------------------\n" ,
