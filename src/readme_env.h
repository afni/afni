...
static char *readme_env[] = {
   ...
   "nearest neighbor (NN) interpolation for zooming (default as of Dec 19,\n" ,
   "2018);  this means that actual data values are represented in the\n" ,
   "window, not some fancy-schmancy interpolated values designed to look \n" ,
   "good but in fact making a mockery of a sham of a mockery of a travesty\n" ,
   "of two mockeries of a sham of reality.\n" ,
   "If set to NO, then it will use linear interpolation, which produces \n"
   "smoother-looking images (with aforementioned caveats for the user).\n" ,
   "\n" ,
   "------------------------------\n" ,
