...
/*
  [PT: Oct 21, 2019] reordered a couple opts, and formatted some of
  the highlighting/syntax to make it easier to parse (for RST/HTML
  help).
*/
...
static char *readme_env[] = {
   ...
   "\n" ,
   "############################################\n" ,
   "###  Vars specifically for 3dDeconvolve  ###\n" ,
   "############################################\n" ,
   "\n" ,
   "---------------------------\n" ,
