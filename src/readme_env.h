...
static char *readme_env[] = {
   ...
   "\n" ,
   "-------------------------------\n" ,
   "Variable: AFNI_SUMA_BOXCOLOR_xx\n" ,
   "-------------------------------\n" ,
   "This string defines the color used for overlaying surface nodes transmitted\n" ,
   "from SUMA to AFNI. This applies to surface number 'xx', for xx=01, 02, etc.\n" ,
   "if this is set to \"none\", then these boxes (at each node near a slice)\n" ,
   "won't be plotted.\n" ,
   ...
   "\n" ,
   "--------------------------------\n" ,
   "Variable: AFNI_SUMA_LINECOLOR_xx\n" ,
   "--------------------------------\n" ,
   "This string defines the color used for overlaying surfaces transmitted\n" ,
   "from SUMA to AFNI. This applies to surface number 'xx', for xx=01, 02, etc.\n" ,
   "if this is set to \"none\", then these lines (intersections of surfaces\n" ,
   "with slices) won't be plotted.\n" ,
   "\n" ,
   "--------------------------------------\n" ,
   "Variable: AFNI_SUMA_LINECOLOR_FORCE_xx\n" ,
   "--------------------------------------\n" ,
   "This variable is similar to AFNI_SUMA_LINECOLOR_xx (again, for xx=01 etc.),\n" ,
   "except for one detail. When SUMA sends a surface to AFNI for display, it\n" ,
   "can also send a color. If that happens, then AFNI_SUMA_LINECOLOR_xx will\n" ,
   "have no effect. But AFNI_SUMA_LINECOLOR_FORCE_xx will over-ride the choice\n" ,
   "SUMA makes and forces the color for surface number 'xx' to be this color.\n" ,
   "\n" ,
   "---------------------------\n" ,
