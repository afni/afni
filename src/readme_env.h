static char * readme_env[] = {
   ...
   "                                 registration\n" ,
   "                               * if this variable is set, then the plugin\n" ,
   "                                 assumes that AFNI_REALTIME_Reg_Base_Mode\n" ,
   "                                 is \"External_Dataset\"\n" ,
   "                               * but AFNI_REALTIME_Base_Image is ignored\n" ,
   "                               * instead, you can use a sub-brick selector here,\n" ,
   "                                 if desired; for example:\n" ,
   "                                 setenv AFNI_REALTIME_External_Dataset 'X+orig[3]'\n" ,
   "                               * to be brutally clear, you can give the name\n" ,
   "                                 of a dataset that is NOT in the current directory\n" ,
   "                                 -- unlike when using the plugin GUI\n" ,
   "                               * the plugin GUI will NOT show the choice of\n" ,
   "                                 external dataset given via this environment\n" ,
   "                                 variable!\n" ,
   "\n" ,
   ...
   "\"TLRC,MNI,MNI_ANAT\". As with AFNI_ATLAS_LIST, this list may also be set to \"ALL\".\n" ,
   "\n" ,
   "----------------------------\n" ,
   ...
   "-------------------------------\n" ,
   "If this variable is set, do NOT make suggestions if a program parsing error is encountered.\n" ,
   "\n" ,
   "--------------------------\n" ,
