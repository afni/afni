static char * readme_env[] = {
   ...
   "-----------------------------------\n" ,
   "If this YES/NO variable is set to YES, then afni will skip the usual\n" ,
   "warning that it pops up in a message window when it discovers a dataset\n" ,
   "is oblique.  (The warning will still be printed\n" ,
   "to stdout.)\n" ,
   "\n" ,
   ...
   "scrollbars.  The default is to give it scroll bars.\n" ,
   "\n" ,
   "-----------------------------\n" ,
   "Variable: AFNI_CLUSTER_REPMAX  (editable)\n" ,
   "-----------------------------\n" ,
   "This numeric variable (between 10 and 99, inclusive) sets the maximum\n" ,
