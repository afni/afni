...
typedef struct {
  int type , nfunc , nparm , pbot , timetype , vfun,vmod,vdim ;
  float tbot,ttop ;
  basis_func *bfunc ;
...
void display_help_menu()
{
  ...
  printf("\n"
    ...
    "                       [The 'SPMGx' models do not take (arguments)!]   \n"
    ...
    "                    -x1D stdout: | 1dplot -one -stdin -xlabel Time     \n"
    "                                                                       \n"
    ...
    "                     * Useful for testing, and if you are going to     \n"
    "                       run 3dREMLfit instead -- that is, you are just  \n"
    "                       using 3dDeconvolve to set up the matrix         \n"
