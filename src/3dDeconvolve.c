...
void display_help_menu(int detail)
{
  ...
  printf("\n"
    ...
    "                    ** Note: 2 different SVD algorithms are available. \n"
    "                       If you get an error message from the default    \n"
    "                       SVD algorithm, re-run 3dDeconvolve with the     \n"
    "                       extra option '-DAFNI_USE_SVDLIB=YES' and see    \n"
