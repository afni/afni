...
THD_mat33 make_shear_matrix( int ax , double scl[3] )
{
   THD_mat33 m ;
...
THD_mat33 permute_mat33( THD_mat33 q , int ox1, int ox2, int ox3 )
{
   THD_mat33 m ;
   int ii , jj , pi[3] ;
...
THD_fvec3 permute_fvec3( THD_fvec3 q , int ox1, int ox2, int ox3 )
{
   THD_fvec3 m ;
   int ii , pi[3] ;
...
MCW_3shear shear_xzyx( THD_mat33 *q , THD_fvec3 *xyzdel )
{
   /* input variables */
...
MCW_3shear shear_arb( THD_mat33 *q , THD_fvec3 *xyzdel , int ox1,int ox2,int ox3 )
{
   THD_mat33 qq ;
   THD_fvec3 xx ;
...
MCW_3shear shear_best( THD_mat33 * q , THD_fvec3 * xyzdel )
{
   MCW_3shear sh[6] ;
   int ii , jbest ;
   double val , best ;
...
THD_mat33 rot_to_matrix( int ax1 , double th1 ,
...
#ifdef DEBUG
fprintf(stderr,"flip0=%d flip1=%d\n",flip0,flip1) ;
#endif
      }
   }
...
MCW_3shear rot_to_shear_matvec( THD_mat33 rmat , THD_fvec3 tvec ,
                                double xdel , double ydel , double zdel )
{
   int flip0=-1 , flip1=-1 ;  /* no flips */
   THD_mat33 q , p ;
...
THD_mat33 MAT_xt_x( THD_mat33 inmat )
{
   THD_mat33 tt,mm ;
...
THD_vecmat MAT_symeig( THD_mat33 inmat )
{
   THD_vecmat out ;
   double a[9] , e[3] ;
   int ii,jj ;
...
THD_mat33 MAT_pow( THD_mat33 inmat , double pp )
{
   THD_mat33 out , mm , dd ;
   THD_vecmat vm ;
   int ii ;
...
THD_mat33 MAT_svdrot( THD_mat33 inmat )
{
   THD_mat33 sq , out , tt ;
