...
static mday holiday[] = {
   ...
   {SEP,20,"Anniversary of Battle of Chalons-sur-Marne"              } ,
   {SEP,21,"Maltese Independence Day"                                } ,
   {SEP,22,"Bilbo and Frodo Baggin's birthday"                       } ,
   {SEP,23,"Augustus Caesar's birthday"                              } ,
   ...
   {NOV,23,"Anniversary of Dr Who's premiere"                        } ,
