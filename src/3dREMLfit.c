...
int main( int argc , char *argv[] )
{
   ...
   if( argc < 2 || strcasecmp(argv[1],"-help") == 0 ){
     ...
     printf(
      ...
      "                                  This volume will be marked as a chi-squared\n"
      "                                  statistic with h-2 degrees of freedom,\n"
      "                                  where 'h' is the semi-arbitrarily chosen\n"
      "                                  maximum lag used. For more fun, see this:\n"
      "                    On a measure of lack of fit in time series models,\n"
      "                    GM Ljung, GEP Box - Biometrika, 1978\n"
      "                    https://academic.oup.com/biomet/article-abstract/65/2/297/236869\n"
      "                                  Note that the LB statistic is computed if and\n"
      "                                  only if you give the '-Rvar' option. You don't\n"
      "                                  have to give the '-Rwherr' option to save the\n"
