...
/********************************************************************************/
/* insertion_sort : sort an array of double + void*                             */

static void isort_doublestuff( int n , double *ar , void **iar )
{
...
static void qsrec_doublestuff( int n , double *ar , void **iar , int cutoff )
{
...
void qsort_doublestuff( int n , double *a , void **ia )
{
   qsrec_doublestuff( n , a , ia , QS_CUTOFF ) ;
   isort_doublestuff( n , a , ia ) ;
   return ;
}
