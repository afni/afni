...
ifdef(`KINDVALUE',,
	`errprint(`****KINDVALUE must be defined as  "text", "OneByteInt", "TwoBytInt", "FourByteInt", "FourByteReal", or "EightByteReal"****')m4exit')dnl
ifdef(`PUTORGET',,
...
ifelse(KINDVALUE,text,`TEXT_DEFINES',
	...
	`errprint(`****KINDVALUE must be "text", "OneByteInt", "TwoBytInt", "FourByteInt", "FourByteReal", or "EightByteReal"****')')
