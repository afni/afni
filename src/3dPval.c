...
int main( int argc , char *argv[] )
{
   ...
   if( argc < 2 || strcmp(argv[1],"-help") == 0 ){
     printf(
      ...
      "   having value-to-FDR conversion curves attached, is an AFNI-only\n"
      "   idea, and is not part of any standard, NIfTI or otherwise!\n"
      ...
      "Options:\n"
      "=======\n"
      " -zscore     = Convert to a z-score instead, an N(0,1) deviate\n"
