                                                   ...
                                                   int read_data)
{
   ...
   fprintf( stderr,
            "-- In Human.colin....FIDUCIAL.TLRC....surf.gii,\n"
            "   there is the DA below:\n"
            "      DataArray Intent=""NIFTI_INTENT_VECTOR""\n"
            "   Its purpose is unkown, but I suspect it contains normals\n");
            
   if (GP->verb > 1 ) 
      SUMA_ShowAfniSurfaceObject(aSO, NULL, 0, 
                                 "verbose output from"
                                 "gifti_surf_to_afni_surf:\n");
