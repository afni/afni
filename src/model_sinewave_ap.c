...
/*
  ...
  sine wave (amplitude and phase parameters) signal model.

  File:     model_sinewave_ap.c
...
/*
  ...
  sine wave model with specified amplitude and phase
  model parameters.
