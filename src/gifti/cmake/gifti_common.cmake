...
#   dashboard_source_name     = Name of source directory (GIFTI)
#   dashboard_binary_name     = Name of binary directory (GIFTI-build)
...
set(dashboard_git_url "https://github.com/NIFTI-Imaging/gifti_clib.git")
endif()
...
if(NOT DEFINED CTEST_SOURCE_DIRECTORY)
  if(DEFINED dashboard_source_name)
    ...
    set(CTEST_SOURCE_DIRECTORY ${CTEST_DASHBOARD_ROOT}/gifti_clib)
  endif()
endif()
...
if(EXISTS ${CTEST_SOURCE_DIRECTORY})
  ...
  if(vcs_refresh AND "${CTEST_SOURCE_DIRECTORY}" MATCHES "/(GIFTI|gifti_clib)[^/]*")
...
")
  ...
  set(CTEST_DROP_LOCATION "/submit.php?project=gifti_clib")
