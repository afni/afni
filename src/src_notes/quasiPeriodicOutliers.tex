...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Normalize time differences to be in the same range as the vs/troughs between pairs of troughs/peaks).
	\end{enumerate}	
\end{enumerate}
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=.8\linewidth]{AlsBaselineCorrected.pdf}
