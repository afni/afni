...
void VL_syntax(void)
{
   printf(
    ...
    "\n"
    "  -maxdisp      = Print the maximum displacement for brain voxels.\n"
    "                    'Brain' here is defined by the same algorithm as used\n"
    "                    in the command '3dAutomask -clfrac 0.33').\n"
    "                    If '-verbose' is given, the max displacement will be\n"
    "                    printed for each sub-brick; otherwise, just the overall\n"
    "                    maximum displacement will get output.\n"
    ...
    "  -maxdisp1D mm = Do '-maxdisp' and write the max displacement for each\n"
