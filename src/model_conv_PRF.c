...
"\n"
"   When viewing the stimulus dataset (where x, y, sigma should match the\n"
"   results), x is -1 to 1 going left to right, while y is -1 to 1 going\n"
"   superior to inferior.  Sigma is a radial measure on the same order.\n"
"\n"
"--------------------------------------------------\n"
...
"\n"
"    * The 2D+time stimulus dataset should preferably have orientation LSA,\n"
"      meaning the x-axis goes left to right, the y-axis goes S to I, and the\n"
"      z-axis has only 1 point.  The results are computed such that left and\n"
"      superior (the staring sides) are negative.  So when viewing the stim\n"
"      dataset, it would make sense to use the same LSA (or any permutation)\n"
"      for the viewing orientation, keeping L and S as negatives.\n"
"\n"
"         afni -orient LSA visual_stim.nii.gz\n"
"              OR\n"
"         afni -DAFNI_ORIENT=LSA visual_stim.nii.gz\n"
"\n"
...
"\n"
"    * Note that the convolved model is demeaned by default, making a\n"
"      Constant noise model unnecessary.\n"
"\n"
