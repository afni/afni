                 ...
                 float ** x_array , float * ts_array   )
{
   ...
   if( g_iter == 0 ) {
      ...
      (void)reset_exp_time_series();     /* precompute exp(x) */
...
"      Serge O. Dumoulin, Brian A. Wandell\n"
"\n"
"   The model is made from parameters A, x0, y0, sigma, and from stmiulus\n"
...
"\n"
"   Currently, x0, y0, and sigma are limited to [-1,1], which the stimlus\n"
...
"      setenv setenv AFNI_MODEL_PRF_STIM_DSET stim.144.bmask.resam+tlrc\n"
"\n"
"   5. And execute:\n"
"\n"
"      3dNLfim -input epi+tlrc          \\\n"
"              -noise Zero              \\\n"
"              -signal Conv_PRF         \\\n"
"              -sconstr 0 -10.0 10.0    \\\n"
"              -sconstr 1 -1.0 1.0      \\\n"
...
"                                    e.g. stim.144.bmask.resam+tlrc\n"
"\n"
"   optional:\n"
"\n"
"      AFNI_MODEL_HELP_CONV_PRF    : Y/N - output this help\n"
"                                    e.g. YES\n"
"   AFNI_MODEL_DEBUG            : speicify debug/verbosity level\n"
