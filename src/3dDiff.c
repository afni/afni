...
"\tIn the 3D case, you get a short message indicating how many elements match.\n"
...
"\tIn the 4D case, the total number of elements AND total number of volumes\n"
" which match are reported.\n"
"%% 3dDiff -a mine.nii -b yours.nii\n"
"++ Images differ: 10 of 10 volumes differ (100.00%%) and 5965461 of 6082560 elements (98.07%%)\n"
"\n"
"2) Using a tolerance to be more permissive\n"
"   (Any voxel difference of 100 units or less is considered equal)\n"
"%% 3dDiff -tol 100 -a mine.nii -b yours.nii\n"
"++ Images differ: 234529 of 608256 elements differ (38.56%%)\n"
"\n"
"3) Using a mask to limit which regions are being compared\n"
...
"N.B. the mask is assumed to be 3D, so volumes past the first are ignored.\n"
"\n"
"===========================================================================\n"
"Reporting Modes ~2~\n"
...
"1) Quiet Mode (-q)\n"
"Returns a single integer value in the range {-1, 0, 1}."
"\t-1 indicates a program error.\n"
"\t0 indicates that the images agree.\n"
...
"Prints out a table of values. Useful for 4D data, but not recommended for 3D.\n"
"Each row of the table will indicate the volume index and number of differing\n"
"elements. At the end of the table, a summary line will appear (see -brutalist).\n"
"Example: the first 10 volumes of two datasets\n"
...
"following order:\n"
"\tSummary        {-1, 0, 1} -1 failure, 1 differences, 0 agreement\n"
"\tDifferences    [0, NV/NT] the number of differing elements (3D) or volumes (4D)\n"
...
"\n"
"  (There is a difference, 596431 elements differed, 608256 elements were\n"
"  compared. The fraction of differing elements is 0.98056.)\n"
"  %% 3dDiff -brutalist -a \"mine.nii[0..9]\" -b \"yours.nii[0..9]\" # 4D\n"
"  1 10 10 1.00000\n"
"\n"
"  (There is a difference, 10 volumes differed, 10 volumes were compared.\n"
"  The fraction of differing volumes is 1.0).\n"
"\n"
"If the program fails for some reason, brutalist output will be an array of\n"
"all -1s, like this:\n"
...
"WARNING: this report is intended for use with humans, not machines! The author\n"
"Makes no guarantee of backwards compatibility for this mode, and will add or\n"
"remove report outputs at his own (shocking whimsical) discretion.\n"
"\n"
"===========================================================================\n"
"See Also ~2~\n"
"\n"
...
"===========================================================================\n"
"Written by %s: \"Perfection is achieved not when there is no data left to\n"
