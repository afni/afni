...
void display_help_menu(void)
{
   printf(
      ...
      "  ++ Please note that voxel-level covariates will slow the program down,\n"
      "      since the regression matrix for the covariates must be re-inverted\n"
      ...
      "  ++ And when the author still had hair.\n"
      "\n"
      "-----------\n"
      "SET OPTIONS\n"
      "-----------\n"
      ...
      "  ++ Centering can be important.  For example, suppose that the IQ\n"
      "      average in setA is higher than in setB, and that the beta\n"
      ...
      "      separately.  3dttest_new now cannot do this type of centering.\n"
      "\n"
