...
"     where\n"
" \n"
"   -insetA    AA   :name of an input set to make a mask from; mask will be\n"
"                    made from nonzero values in AA;\n"
"   -insetB    BB   :name of an input set to make a mask from; mask will be\n"
"                    made from nonzero values in BB;\n"
" \n"
"   -prefix    PP   :prefix of output files.\n"
"                    Three output text files will be named according to the\n"
"                    orientation of the input AA and BB files.  So, outputs might\n"
"                    look like:\n"
...
"                   :optional specification of the slices over which to output\n"
"                    Dice coefficient results along each axis, via keyword. \n"
"                    Argument options at present:\n"
"                    'all':   report Dice values for all slices (default);\n"
"                    'AorB':  report values only in slices where sets A or B\n"
"                             (or both) have at least one nonzero voxel;\n"
"                    'AandB': report values only in slices where both sets A \n"
"                             and B have at least one nonzero voxel;\n"
...
"                             has at least one nonzero voxel;\n"
" \n"
"   -no_cmd_echo    :turn OFF recording the command line call to 3dSliceNDice\n"
"                    in the output *.1D files (default is to do the recording).\n"
" \n"
" * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *\n"
" \n"
" EXAMPLES ~1~\n"
