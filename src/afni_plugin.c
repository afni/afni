...
/*-------------------------------------------------------------------------
   Routine to create a 3D 'fim' dataset from a 3D+time dataset,
   ...
   where tzero  =  time at ts[0]
       ...
       ts_slope =  slope of ts array;
         ...
         val    =  pointer to return value for this voxel;
                                          ...
                                          void * user_data )
{
   ...
   switch( new_datum ){
      ...
      case MRI_short:{
         ...
         if( bout == NULL ){
            fprintf(stderr,"\nFinal malloc error in PLUTO_4D_to_fim\n\a") ;
            exit(1) ;
         }
   ...
   switch( new_datum ){
      ...
      case MRI_short:{
         ...
         if( (bout == NULL) || (tbout == NULL) ){
            fprintf(stderr,"\nFinal malloc error in PLUTO_4D_to_fith\n\a") ;
            exit(1) ;
         }
