...
void display_help_menu(void)
{
   printf(
      ...
      "\n"
      " ++ In fact, there are those who argue (convincingly) that if your\n"
      "    two groups differ markedly in their mean covariate values, then\n"
      "    there is NO statistical test that can tell if their mean beta\n"
      "    values (dependent variable) would be the same or different if\n"
      "    their covariate values were all the same instead:\n"
      ...
      "     be due to either cause and you can't turn the results from a set of\n"
      "     high IQ controls into the results you would have gotten from a set of\n"
      "     normal IQ controls (so you can compare to the patients) just by\n"
      "     linear regression and then pretending the IQ issue goes away.\n"
      ...
      "     (supra) for a discussion of this issue.\n"
      "\n"
