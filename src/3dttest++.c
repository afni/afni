...
void display_help_menu(void)
{
   printf(
     ...
     "\n"
      ...
      "                          in the FWHM parameter. If the inputs to 3dttest++\n"
      ...
      "                       ++ The list of blur FWHM parameters can have up to 9\n"
      "                          entries, but I recommend no more than 4 of them;\n"
      "                          2 or 3 might work best.\n"
