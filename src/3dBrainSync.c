...
void BSY_help_the_pitiful_user(void)
{
  printf(
   ...
   "  (at least for me). Another 'feature' of a permutation-only transformation\n"
   "  is that it cannot change the sign of data, unlike a general orthgonal\n"
   "  matrix; e.g., [ 0 -1]\n"
   "                [-1  0], which swaps 2 time points AND negates them, is a\n"
