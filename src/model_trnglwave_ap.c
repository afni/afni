...
/*
  ...
  triangular wave (amplitude and phase parameters) signal model.

  File:     model_trnglrwave_ap.c
...
/*
  ...
  triangular wave model with specified amplitude and phase parameters.
...
{
  const float FREQ = 0.125;         /* frequency of the triangular wave */
  int it;                           /* time index */     
  float t;                          /* time */
