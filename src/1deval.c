...
int main( int argc , char * argv[] )
{
   ...
   if( argc < 3 ){
      printf("Usage: 1deval [options] -expr 'expression'\n"
             ...
             "A Trick:\n"
             "--------\n"
             "If you use some other letter than 'z' as the independent variable\n"
             "in the calculation, then 'z' in the expression will be the previous\n"
             "value computed.  This trick can be used to create 1 point recursions,\n"
             "as in the following for creating a AR(1) noise time series:\n"
             ...
             "independent variable generated by '-del' and '-start'.\n"
             "\n"
             "-- RW Cox --\n"
            ) ;
   ...
   for( ii=0 ; ii < num ; ii++ ){
      ...
      if( kvar != 25 ) atoz[25]   = value ;  /* z = last output */
