...
void TCAT_Syntax(void)
{
   ...
   printf(
    ...
    "                     from each of a number of 3D+time datasets.  Note\n"
    "                     that the entire dataset specification is in quotes\n"
    "                     to prevent the shell from doing the wildcard\n"
    "                     expansion -- it will be done inside the program\n"
    "                     itself, after the sub-brick selector is temporarily\n"
