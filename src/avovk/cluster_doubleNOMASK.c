...
static
double cityblock (int n, double** data1, double** data2, const double weight[], int index1, int index2, int transpose)
...
static
double acorrelation (int n, double** data1, double** data2, const double weight[], int index1, int index2, int transpose)
/*
Purpose
=======
...
{ int i,j;
  ...
  { result[i] += 1.0;
    for (j = 0; j < i; j++)
    { const double distance = metric(ndata, data, data, weights,
                                     i, j, transpose);
      if (distance < cutoff)
