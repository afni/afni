...
/********************************************************************************/
/* insertion_sort : sort an array of float + int64_t                                */

static void isort_floatint64_t( int64_t n , float * ar , int64_t * iar )
{
...
static void qsrec_floatint64_t( int64_t n , float * ar , int64_t * iar , int64_t cutoff )
{
...
void qsort_floatint64_t( int64_t n , float * a , int64_t * ia )
{
   qsrec_floatint64_t( n , a , ia , QS_CUTOFF ) ;
   isort_floatint64_t( n , a , ia ) ;
   return ;
}
